// =========================================================
// 1. MENU UNIFICADO (Suas ferramentas + Relatório)
// =========================================================
function onOpen() {
...
function atualizarRelatorio() {
  ...
  // Memória para preencher cursos de células agrupadas/vazias
...
function enviarRelatorioExcel() {
  ...
  MailApp.sendEmail({
    to: email, cc: cc,
    subject: "Planilha Ingressantes - " + Utilities.formatDate(new Date(), "GMT-3", "dd/MM/yyyy"),
    body: "Segue em anexo a planilha dos ingressantes.",
    attachments: [blob]
  });
...
function getTabelas() {
  ...
  const emailsGestores = {
      "ADM": "gestor.administracao@instituicao.edu.br",
      "Med Vet": "gestor.medvet@instituicao.edu.br / pedagogico.medvet@instituicao.edu.br",
      "Eng Mecânica": "gestor.engcontrole@instituicao.edu.br",
      "Eng Produção": "gestor.engcontrole@instituicao.edu.br",
      "Eng Aut": "gestor.engcontrole@instituicao.edu.br",
      "Eng Civil": "gestor.engcontrole@instituicao.edu.br",
      "Arquitetura": "gestor.arquitetura@instituicao.edu.br",
      "BCC": "gestor.computacao@instituicao.edu.br",
      "RH": "pedagogico.administracao@instituicao.edu.br",
      "Ed Física": "pedagogico.edfisica@instituicao.edu.br",
      "Contábeis": "pedagogico.contabeis@instituicao.edu.br",
      "IA": "coordenador.ia@instituicao.edu.br",
      "Biomedicina": "gestor.biomedicina@instituicao.edu.br",
      "Direito": "pedagogico.direito@instituicao.edu.br",
      "Enfermagem": "pedagogico.enfermagem@instituicao.edu.br",
      "Farmácia": "gestor.farmacia@instituicao.edu.br",
      "Fisioterapia": "pedagogico.fisioterapia@instituicao.edu.br",
      "Nutrição": "gestor.nutricao@instituicao.edu.br",
      "Pedagogia": "gestor.pedagogia@instituicao.edu.br",
      "Psicologia": "gestor.psicologia@instituicao.edu.br",
      "Marketing": "pedagogico.administracao@instituicao.edu.br",
      "Logística": "pedagogico.administracao@instituicao.edu.br"
  };
